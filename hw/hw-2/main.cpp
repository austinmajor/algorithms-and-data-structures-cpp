...
int main()
{
	...
	while(running) {
		...
		switch(parsedSelection) {
			case 1: {
				std::cout << std::endl << cars.print() << std::endl;
				break;
			}
			case 2: {
				...
				try {
					std::cout << 
						car::PrintModel(cars.findByID(parsedSelection))
						<< std::endl << std::endl;
				} catch(const char* e) {
			...
			case 3: {
				...
				if(size == 0) {
					std::cout << "No cars found by given make, returning to menu." << std::endl << std::endl;
					continue;
				}
			...
			case 4: {
				...
				if(size == 0) {
					std::cout << "No cars found by given model, returning to menu." << std::endl << std::endl;
					continue;
				}
			...
			case 5: {
				...
				if(size == 0) {
					std::cout << "No cars found by given color, returning to menu." << std::endl << std::endl;
					continue;
				}
